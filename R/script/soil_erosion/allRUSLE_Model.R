...
setwd("C:\\Users\\ATilaye\\Documents\\01My_Docs\\01CIAT\\01Landscape_Doctor\\github\\R\\script\\soil_erosion")
...
p <- terra::resample(p, c, method = 'bilinear') %>% crop(c) %>% mask(c)
